    ...
    <div class="card p-5 mt-5 container">
        <form name="commentsForm " method="post" action="/comments/update" id="ddd">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" class="form-control" id="title" value="<?=$comment->title ?>" aria-describedby="emailHelp" required>
            </div>
            <div class="form-floating mb-3">
                <textarea name="content" class="form-control" placeholder="Leave a comment here"
                          id="floatingTextarea" required><?=$comment->content ?></textarea>
